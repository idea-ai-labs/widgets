...
export default function PromptGenerator() {
  ...
  const handleReset = () => setFields(emptyFields(promptType));
  ...
  return (
    <div style={styles.root}>
      ...
      <div style={styles.actions}>
        <button type="button" onClick={handleCopy} style={{ ...styles.actionBtn, ...styles.actionBtnPrimary }}>
          {copied ? "✓ Copied!" : "⧉ Copy Prompt"}
        </button>
        <button type="button" onClick={handleDownload} style={styles.actionBtn}>
          ↓ Download .txt
        </button>
        <button type="button" onClick={handleReset} style={{ ...styles.actionBtn, ...styles.actionBtnDanger }}>
          ↺ Reset
        </button>
      </div>
